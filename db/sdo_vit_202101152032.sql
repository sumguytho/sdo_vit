...
-- Дата скрипта: 15.01.2021 20:32:49
...
--
-- Удалить процедуру `addUser`
--
DROP PROCEDURE IF EXISTS addUser;

--
-- Удалить процедуру `authUser`
--
DROP PROCEDURE IF EXISTS authUser;

--
-- Удалить процедуру `getUserType`
--
DROP PROCEDURE IF EXISTS getUserType;

--
-- Удалить таблицу `chat_membership`
--
...
--
-- Удалить процедуру `getDesks`
--
DROP PROCEDURE IF EXISTS getDesks;

--
-- Удалить таблицу `desk_membership`
--
DROP TABLE IF EXISTS desk_membership;

--
-- Удалить таблицу `answer`
--
DROP TABLE IF EXISTS answer;

--
-- Удалить таблицу `attachment`
--
...
--
-- Удалить процедуру `getUserByLogin`
--
...
--
CREATE TABLE desk (
  deskId int UNSIGNED NOT NULL AUTO_INCREMENT,
  name varchar(50) NOT NULL,
...
--
CREATE TABLE desk_membership (
  deskMembershipId int UNSIGNED NOT NULL AUTO_INCREMENT,
  deskId int UNSIGNED NOT NULL,
  groupId int UNSIGNED NOT NULL,
...
CREATE TABLE chat_membership (
  chatMembershipId int UNSIGNED NOT NULL AUTO_INCREMENT,
  userId int UNSIGNED NOT NULL,
  chatId int UNSIGNED NOT NULL,
...
(2, 'Иван', 'Цветков', 'Андреевич', '2020-12-24', 123456, 'll@mm.ru', '202cb962ac59075b', 'wau', '2', 1),
(3, 'root', 'root', 'root', '2020-12-17', 0, 'L', '81dc9bdb52d04dc2', 'root', '0', 2),
(4, 'Вовен', 'Гериханов', 'Русланович', '2021-01-14', 123123, 'hackermanfromhell@gmail.com', '202cb962ac59075b', 'prep', '0', 1),
(5, 'Александр', 'Волков', 'Александрович', '2021-01-20', 123123, 'hackermanfromhell@gmail.com', '76d80224611fc919', 'qwe', '1', 1),
(6, 'asd', 'asd', 'asd', '2020-12-31', 213123, 'asd', 'qweqwqweqwewew', 'zxc', '2', 2),
(7, 'Юрий', 'Мадрасов', 'Викторович', '1999-03-07', 170051, 'dr.cs@ya.ru', 'e48e13207341b6bf', 'yurim', '2', 1);
